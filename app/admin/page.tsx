...
export default function AdminPage() {
  ...
  const load = useCallback(async () => {
    ...
    setMe(session.user);
    const [eventData, userData, overviewData, syncData] = await Promise.all([api("/api/admin/events"), api("/api/admin/users"), api("/api/admin/overview"), api("/api/admin/participants/sync")]);
